...
helpImproveToggle?.addEventListener('change', async () => {
  await chrome.storage.local.set({ helpImproveSincetoggle: helpImproveToggle.checked }).catch(() => {});
});
