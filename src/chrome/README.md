...
- **Protected browser pages** — Browser-internal and extension-store pages restrict content-script/CDP access; Since Toggle reports these as protected instead of retrying DOM actions.
